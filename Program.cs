            ...
            while (OPnumber <= 17)
            {
                switch (OPnumber)
                {
                    ...
                    case 4://============================================= O P A R A T I O N 4 =====================================================
                        ...
                        /*string[] DNA_strand = new string[blobDNAarray.Length/3];
                        int op4 = 0;
                        for (int i = 0; i < blobDNAarray.Length; i = i + 3)
                        {
                            DNA_strand[op4] = blobDNAarray[i].ToString() + blobDNAarray[i + 1].ToString() + blobDNAarray[i + 2].ToString();
                        ...
                        if (flag_4 == 0)
                        {
                            if (DNA_strand[0] != "ATG" || DNA_strand[DNA_strand.Length - 1] != "TAA" && DNA_strand[DNA_strand.Length - 1] != "TGA" && DNA_strand[DNA_strand.Length - 1] != "TAG")
                                flag_4 = 1;
                            for (int i = 0; i < DNA_strand.Length; i += 2)
                            {
                                for (int j = i; j < DNA_strand.Length; j += 2)
                                {
                                    if (DNA_strand[j] == "ATG")
                                    {
                                        index_first = j;
                                    }
                                    else if (DNA_strand[j] == "TAA" || DNA_strand[j] == "TGA" || DNA_strand[j] == "TAG")
                                    {
                                        index_last = j;
                                        if (index_last != DNA_strand.Length - 1 && DNA_strand[index_last + 2] != "ATG")
                                            flag_4 = 1;
                                        else
                                        {
                                            for (int k = index_first + 2; k < index_last; k += 2)
                                            {
                                                if (DNA_strand[k] == "ATG" || DNA_strand[k] == "TAA" || DNA_strand[k] == "TGA" || DNA_strand[k] == "TAG")
                                                    flag_4 = 1;
                                            }
                                        }
                                    }
